...
/**
 * Defines the asynchronous transport layer for the Model Context Protocol
 * (MCP).
 * 
 * <p>
 * The McpTransport interface provides the foundation for implementing custom
 * transport
 * mechanisms in the Model Context Protocol. It handles the bidirectional
 * communication between
 * the client and server components, supporting asynchronous message exchange
 ...
 * implementations
 * such as WebSocket, HTTP, or custom protocols.
 * </p>
 *
...
public interface McpTransport {
     ...
     * 
     * <p>
     * This method should be called before any message exchange can occur. It sets
     * up
     * the necessary resources and establishes the connection to the server.
     * </p>
     */
    void start();
     ...
     * 
     * <p>
     * This method ensures proper cleanup of resources when the transport is no
     * longer needed.
     ...
     * asynchronously.
     * 
     * @return a {@link Mono<Void>} that completes when the connection has been
     *         closed.
     */
     ...
     * 
     * <p>
     * The provided handler will be called whenever a new message is received from
     * the server.
     * Messages are expected to follow the JSON-RPC format as defined in the MCP
     * specification.
     * </p>
     *
     ...
     * 
     * <p>
     * This method handles the transmission of messages to the server in an
     * asynchronous manner.
